...
vim.keymap.set("n", "<C-j>", "10<C-w>j")
vim.keymap.set("n", "<C-k>", "10<C-w>k")
vim.keymap.set("n", "<C-l>", "10<C-w>l")
...
vim.keymap.set("n", "<A-h>", "10<C-w><")
vim.keymap.set("n", "<A-j>", "10<C-w>+")
vim.keymap.set("n", "<A-k>", "10<C-w>-")
vim.keymap.set("n", "<A-l>", "10<C-w>>")
